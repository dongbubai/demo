...
public class MySheBaoAction extends AbstractMobileAction {
	...
	public Object queryPage_body(String userid, Object obj, int startnum,
		...
		try {
			...
			html.append("<div style='text-align:left;heigth:auto;'><span style='color:#000000;'> 人员编码:" + psncode + " </span></p>");
			html.append("<div style='text-align:left;heigth:auto;'><span style='color:#000000;'> 姓名:" + psnname + " </span></p>");

			html.append("<div style='text-align:left;heigth:auto;'><span style='color:#000000;'> 任职组织:" + hrorgheadvo.getName() + " </span></p>");
